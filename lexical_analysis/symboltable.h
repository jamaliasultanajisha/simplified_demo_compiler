...
public:
    ...
    int collision=0;
    ~hash_Map();
    void insert_item(string str,int key,int value,string namestr,FILE *logout);
...
struct symbolTable
{
    bool insertCurrent(struct hash_Map* current,string str,int key,int value,string namestr,FILE *logout);
...
bool symbolTable::insertCurrent(struct hash_Map* curr,string str,int key,int value,string namestr,FILE *logout)
{
    curr->insert_item(str,key,value,namestr,logout);
}
...
void hash_Map::insert_item(string str,int key,int value,string namestr,FILE *logout)
{
    int key_real=key;
